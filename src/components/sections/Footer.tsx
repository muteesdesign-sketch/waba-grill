  ...
  return (
    <footer className="bg-ink px-6 py-12 text-white">
      ...
      <p className="mt-4 max-w-[320px] text-sm leading-relaxed text-white/70">
        Fresh, grilled-to-order meals designed to nourish your body and satisfy
        your cravings.
      </p>
      ...
      <form className="mt-3 flex flex-col gap-3">
        <input
          ...
          className="rounded-full bg-white px-5 py-3.5 text-sm text-ink placeholder:text-ink/50 focus:outline-none focus:ring-2 focus:ring-brand"
        />
        <button
          type="submit"
          className="rounded-full bg-brand-button px-5 py-3.5 text-sm font-bold uppercase tracking-wide text-white transition-colors hover:bg-brand"
        >
          Sign Up
        </button>
      </form>
